...
export default function App() {
  ...
  return <>
    ...
    <FlowMonitorProvider settings={settings} snapshot={monitor.snapshot}>
      <div className="view-panel" hidden={view !== 'flow'}><Suspense fallback={<main className="workspace"><div className="chart-loading">正在连接异常监控…</div></main>}><FlowDashboard settings={settings} snapshot={monitor.snapshot} active={view === 'flow'} historyVersion={monitor.historyVersion} onOpenSettings={() => setDialog('settings')}/></Suspense></div>
